...
<template>
    ...
    <div class="flex flex-col mt-10 ml-2 md:ml-5">
        <div class="flex flex-col">
            <p class="w-30 pl-2 mb-5 rounded-md text-sm rotate-3 p-1 bg-sky-300 font-medium text-white animate-pulse">Experience ++</p>
            <h1
        ...
        <div class="mt-3">
            <span ref="el" class="text-xl font-semibold gradentText"></span>
        </div>
        <div class="mt-10 font-medium text-stone-400">
            <p class="w-75 md:w-100">Specializing in web infrastructure, authentication, monitoring systems, and scalable backend APIs.</p>
        </div>
        ...
        <div class="flex justify-start gap-2">
            <button class="p-3 px-7 border border-stone-500 text-stone-500 text-xl font-semibold rounded-lg">Start a Project</button>
        </div>
        </div>
    ...
    <div class="">
        ...
        <img class="w-64  h-64 rounded-full md:w-100 md:h-100" :src="data.profile" alt="">
...
.gradentText {
    @apply bg-gradient-to-r from-sky-400 to-violet-400 bg-clip-text text-transparent
};
.gradentTextv2 {
